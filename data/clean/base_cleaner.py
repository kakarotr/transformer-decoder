...
print(
    cleaner.clean(
        "ǖǖǖҰҰҰѮѮѮԚԚԚຄຄຄफफफࠊݕݕݕ过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。过滤大量重复行的文档（常见于模板页、列表爬取噪声）。"
    )
)
